...
<body class="d-flex align-items-center min-h-100">
  ...
  <header class="position-absolute top-0 left-0 right-0 mt-3 mx-3">
    <div class="d-flex d-lg-none justify-content-between">
      <a href="index.html">
        <img class="w-100" src="./assets/img/logo_png/logo_ysl.png" alt="Image Description" style="min-width: 7rem; max-width: 7rem;">
      </a>
    </div>
  </header>
  <!-- ========== END HEADER ========== -->
  ...
  <main id="content" role="main" class="main pt-0">
    ...
    if (isset($_POST['submit'])) {
      ...
      if ($row !== 0) {
        ...
        VALUES ('$_POST[email]','$_POST[fullName] $_POST[lastName]','$_POST[password]','user','active','3','$Date')";
        ...
        <div class="col-lg-6 d-flex justify-content-center align-items-center min-vh-lg-100">
          <div class="w-100 pt-10 pt-lg-7 pb-7" style="max-width: 25rem;">
            ...
            <form class="js-validate" method="POST" action="">
              ...
              <button type="submit" name="submit" class="btn btn-lg btn-block btn-primary mb-2">Create an account</button>
