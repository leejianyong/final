                    ...
                    <div class="card h-100">
                      ...
                      <div class="card-body text-center">
                        ...
                        <div class="avatar avatar-xl avatar-soft-primary avatar-circle avatar-border-lg avatar-centered mb-3">
                          <img class="avatar-img" src="../<?= ($array['profile_image'])?'/image/'.$array['profile_image']:'/assets/img/160x160/img2.jpg'; ?>" alt="Image Description">
                          <span class="avatar-status avatar-sm-status avatar-status-success"></span>
                        </div>
                        <!-- End Avatar -->

                        <h3 class="mb-1">
                          <a class="text-dark" href="#"><?= $array['company_name']; ?></a>
                        </h3>

                        <div class="mb-3">
                          <i class="tio-city mr-1"></i>
                          <span><?= $array['contact']; ?></span>
                        </div>
                      ...
                      <div class="card-footer">
                        <div class="row justify-content-between align-items-center">
                          <div class="col-auto py-1">
                            <a class="font-size-sm text-body" href="#"><?= $array['country']; ?></a>
                          </div>

                          <div class="col-auto py-1">
                            <!-- Checkbox -->
                            <a class="btn btn-outline-secondary" href="profile-company.php?detail=<?= $array['userid']; ?>">View Detail</a>
                            <!-- End Checkbox -->
                          </div>
